...
/*
static int comp_gl_str_value(const void *a, const void *b)
{
   return strcmp(((struct gl_str_value*)a)->str, ((struct gl_str_value*)b)->str); 
}
*/
...
static GLenum get_enum(const char *str, int n)
{
   ...
   return ENUM_ERROR;
   /*
   gl_str_value *res, key;
   char *buf = (char *)malloc(n+1);
   strncpy(buf, str, n);
   buf[n]='\0';
   key.str = buf;

   res = bsearch( &key, gl_str, sizeof(gl_str)/sizeof(gl_str[0])-1, sizeof(struct gl_str_value), comp_gl_str_value );
   free(buf);

   return res ? res->value : ENUM_ERROR;
   */
}
...
static int gl_accum(lua_State *L)
{
   ...
   /* test argument */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.Accum'");

   e = get_gl_enum(L, 1);

   /* test arguments */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.Accum'");
...
static int gl_alpha_func(lua_State *L)
{
   ...
   /* test argument */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.AlphaFunc'");

   e = get_gl_enum(L, 1);

   /* test arguments */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.AlphaFunc'");
...
static int gl_are_textures_resident(lua_State *L)
{
   ...
   /* test argument */
   if(!lua_istable(L, 1))
      ShowError("incorrect argument to function 'gl.AreTexturesResident'");

   /* get textures array */
   n = get_arrayui(L, 1, &textures);

   residences = NEW_ARRAY(GLboolean, n);
...
static int gl_array_element(lua_State *L)
{
   /* test argument */
   if(!lua_isnumber(L, 1))
      ShowError("incorrect argument to function 'gl.ArrayElement'");
...
static int gl_begin(lua_State *L)
{
   ...
   /* test argument */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.Begin'");

   e = get_gl_enum(L, 1);

   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.Begin'");
...
static int gl_bind_texture(lua_State *L)
{
   ...
   if(!( lua_isstring(L, 1) && lua_isnumber(L, 2) ))
      ShowError("incorrect argument to function 'gl.BindTexture'");
   ...
   /* test arguments */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.BindTexture'");
...
static int gl_bitmap(lua_State *L)
{
   ...
   if(!( lua_isnumber(L, 1) && lua_isnumber(L, 2) &&
      ...
      ShowError("incorrect argument to function 'gl.Bitmap'");
...
static int gl_blend_equation(lua_State *L)
{
   GLenum mode;

   // test arguments
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.BlendEquation'");
   ...
   // test arguments
   if((mode == ENUM_ERROR))
      ShowError("incorrect string argument to function 'gl.BlendFunc'");
...
static int gl_blend_func(lua_State *L)
{
   ...
   if(!(lua_isstring(L, 1) && lua_isstring(L, 2)))
      ShowError("incorrect argument to function 'gl.BlendFunc'");
...
static int gl_call_list(lua_State *L)
{
   /* test argument */
   if(!lua_isnumber(L, 1))
      ShowError("incorrect argument to function 'gl.CallList'");
...
static int gl_call_lists(lua_State *L)
{
   ...
   /* test argument */
   if(!lua_istable(L, 1))
      ShowError("incorrect argument to function 'gl.CallLists'");
...
static int gl_clear(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.Clear'");

   e = get_gl_enum(L, 1);

   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.Clear'");
...
static int gl_clear_accum(lua_State *L)
{
   ...
   if(!( lua_isnumber(L, 1) && lua_isnumber(L, 2) && lua_isnumber(L, 3) && lua_isnumber(L, 4) ))
      ShowError("incorrect argument to function 'gl.ClearAccum'");
...
static int gl_clear_color(lua_State *L)
{
   /* test arguments type */
   if(!( lua_isnumber(L, 1) && lua_isnumber(L, 2) && lua_isnumber(L, 3) && lua_isnumber(L, 4) ))
      ShowError("incorrect argument to function 'gl.ClearColor'");
...
static int gl_clear_depth(lua_State *L)
{
   /* test argument type */
   if(!lua_isnumber(L, 1))
      ShowError("incorrect argument to function 'gl.ClearDepth'");
...
static int gl_clear_index(lua_State *L)
{
   /* test argument type */
   if(!lua_isnumber(L, 1))
      ShowError("incorrect argument to function 'gl.ClearIndex'");
...
static int gl_clear_stencil(lua_State *L)
{
   /* test argument type */
   if(!lua_isnumber(L, 1))
      ShowError("incorrect argument to function 'gl.ClearStencil'");
...
static int gl_clip_plane(lua_State *L)
{
   ...
   /* test arguments */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.ClipPlane'");
   ...
   /* test argument */
   if(plane == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.ClipPlane'");
...
static int gl_color(lua_State *L)
{
   ...
   for(index = 0; index < num_args; index++)
   {
      if(!lua_isnumber(L, index + 1))
         ShowError("incorrect argument to function 'gl.Color'");
   }
...
static int gl_color_mask(lua_State *L)
{
   ...
   if(!( lua_isboolean(L, 1) && lua_isboolean(L, 2) && lua_isboolean(L, 3) && lua_isboolean(L, 4) ))
      ShowError("incorrect argument to function 'gl.ColorMask'");
...
static int gl_color_material(lua_State *L)
{
   ...
   /* test arguments */
   if(!( lua_isstring(L, 1) && lua_isstring(L, 2) ))
      ShowError("incorrect argument to function 'gl.ColorMaterial'");
   ...
   if(e1 == ENUM_ERROR || e2 == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.ColorMaterial'");
...
static int gl_color_pointer(lua_State *L)
{
   ...
   /* test arguments type */
   if(!lua_istable(L, 1))
      ShowError("incorrect argument to function 'gl.ColorPointer'");

   if(lua_isnumber(L, 2))
   {
      size = (GLint)lua_tonumber(L, 2);
      get_arrayd_pointer(L, 1, &array);
   }
   else if(get_array2d_pointer(L, 1, &array, &size) == -1)
   {
      ShowError("incorrect argument to function 'gl.ColorPointer'");
      return 0;
   }
...
static int gl_copy_pixels(lua_State *L)
{
   ...
   if(!( lua_isnumber(L, 1) && lua_isnumber(L, 2) &&
      ...
      ShowError("incorrect argument to function 'gl.CopyPixels'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.CopyPixels'");
...
static int gl_copy_tex_image(lua_State *L)
{
   ...
   if(!(lua_isnumber(L, 1) && lua_isstring(L, 2) && lua_isnumber(L, 3) &&
      ...
      ShowError("incorrect argument to function 'gl.CopyTexImage'");
   ...
   if(internalFormat == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.CopyTexImage'");
...
static int gl_copy_tex_sub_image(lua_State *L)
{
   ...
   {
      if(!lua_isnumber(L, index + 1))
         ShowError("incorrect argument to function 'gl.CopyTexSubImage'");
   }
...
static int gl_cull_face(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.CullFace'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.CullFace'");
...
static int gl_delete_lists(lua_State *L)
{
   /* test arguments type */
   if(!( lua_isnumber(L, 1) && lua_isnumber(L, 2) ))
      ShowError("incorrect argument to function 'gl.DeleteLists'");
...
static int gl_delete_textures(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_istable(L, 1))
      ShowError("incorrect argument to function 'gl.DeleteTextures'");
...
static int gl_depth_func(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.DepthFunc'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.DepthFunc'");
...
static int gl_depth_mask(lua_State *L)
{
   ...
   if(!lua_isboolean(L, 1))
      ShowError("incorrect argument to function 'gl.DepthMask'");
...
static int gl_depth_range(lua_State *L)
{
   /* test arguments type */
   if(!( lua_isnumber(L, 1) && lua_isnumber(L, 2) ))
      ShowError("incorrect argument to function 'gl.DepthRange'");
...
static int gl_disable(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.Disable'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.Disable'");
...
static int gl_disable_client_state(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.DisableClientState'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.DisableClientState'");
...
static int gl_draw_arrays(lua_State *L)
{
   ...
   if(!(lua_isstring(L, 1) && lua_isnumber(L, 2) && lua_isnumber(L, 3) ))
      ShowError("incorrect argument to function 'gl.DrawArrays'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.DrawArrays'");
...
static int gl_draw_buffer(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.DrawBuffer'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.DrawBuffer'");
...
static int gl_draw_elements(lua_State *L)
{
   ...
   if(!( lua_isstring(L, 1) && lua_istable(L, 2) ))
      ShowError("incorrect argument to function 'gl.DrawElements'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.DrawElements'");
...
static int gl_draw_pixels(lua_State *L)
{
   ...
   if(!(lua_isnumber(L, 1) && lua_isnumber(L, 2) &&
      ...
      ShowError("incorrect argument to function 'gl.DrawPixels'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.DrawPixels'");
...
static int gl_edge_flag(lua_State *L)
{
   ...
   if(lua_istable(L, 1))/* test argument type */
   {
      ...
      ShowError("incorrect argument to function 'gl.EdgeFlag'");
...
static int gl_edge_flag_pointer(lua_State *L)
{
   ...
   /* test arguments type */
   if(!lua_istable(L, 1))
      ShowError("incorrect argument to function 'gl.EdgeFlagPointer'");

   /* get argument */
   get_arrayb_pointer(L, 1, &flags);
...
static int gl_enable(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.Enable'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.Enable'");
...
static int gl_enable_client_state(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.EnableClientState'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.EnableClientState'");
...
static int gl_eval_coord(lua_State *L)
{
   ...
   for(index = 0; index < num_args; index++)
      if(!lua_isnumber(L, index + 1))
         ShowError("incorrect argument to function 'gl.EvalCoord'");
...
static int gl_eval_mesh(lua_State *L)
{
   ...
   if(!( lua_isstring(L, 1) && num_args > 2))
      ShowError("incorrect argument to function 'gl.EvalMesh'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.EvalMesh'");
...
static int gl_eval_point(lua_State *L)
{
   ...
   for(index = 0; index < num_args; index++)
      if(!lua_isnumber(L, index + 1))
         ShowError("incorrect argument to function 'gl.EvalPoint'");
...
static int gl_feedback_buffer(lua_State *L)
{
   ...
   if(!( lua_isnumber(L, 1) && lua_isstring(L, 2) ))
      ShowError("incorrect argument to function 'gl.FeedbackBuffer'");

   /* get parameters */
   size = (GLsizei)lua_tonumber(L, 1);
   e = get_gl_enum(L, 2);

   array = NEW_ARRAY(GLfloat, size);

   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.FeedbackBuffer'");
...
static int gl_fog(lua_State *L)
{
   ...
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.Fog'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.Fog'");
...
static int gl_front_face(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.FrontFace'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.FrontFace'");
...
static int gl_frustum(lua_State *L)
{
   ...
   for(index = 0; index < 6; index++)
      if(!lua_isnumber(L, index + 1))
         ShowError("incorrect argument to function 'gl.Frustum'");
...
static int gl_gen_lists(lua_State *L)
{
   /* test argument type */
   if(!lua_isnumber(L, 1))
      ShowError("incorrect argument to function 'gl.GenLists'");
...
static int gl_gen_textures(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isnumber(L, 1))
      ShowError("incorrect argument to function 'gl.GenTextures'");

   n = (GLsizei)lua_tonumber(L, 1);
   textures = NEW_ARRAY(GLuint, n);
...
static int gl_get(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.Get'");
   ...
   switch(e)
   {
      ...
      case ENUM_ERROR:
         ShowError("incorrect string argument to function 'gl.Get'");
         break;
   }
   params = NEW_ARRAY(GLdouble, size);
...
static int gl_get_const(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.GetConst'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.GetConst'");

   params = NEW_ARRAY(GLenum, size);
...
static int gl_get_array(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.GetArray'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.GetArray'");
...
static int gl_get_clip_plane(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.GetClipPlane'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.GetClipPlane'");

   equation = NEW_ARRAY(GLdouble, 4);
...
static int gl_get_light(lua_State *L)
{
   ...
   /* test arguments type */
   if(!( lua_isstring(L, 1) && lua_isstring(L, 2) ))
      ShowError("incorrect argument to function 'gl.GetLight'");
   ...
   /* test argument */
   if(e1 == ENUM_ERROR || e2 == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.GetLight'");
...
static int gl_get_map(lua_State *L)
{
   ...
   order = NEW_ARRAY(GLint, 2);
   order[0] = order[1] = 1;

   /* test arguments type */
   if( !(lua_isstring(L, 1) && lua_isstring(L, 2)) )
      ShowError("incorrect argument to function 'gl.GetMap'");
   ...
   /* test argument */
   if(e1 == ENUM_ERROR || e2 == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.GetMap'");
...
static int gl_get_material(lua_State *L)
{
   ...
   /* test arguments type */
   if( !(lua_isstring(L, 1) && lua_isstring(L, 2)) )
      ShowError("incorrect argument to function 'gl.GetMaterial'");
   ...
   /* test argument */
   if(e1 == ENUM_ERROR || e2 == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.GetMaterial'");
...
static int gl_get_pixel_map(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.GetPixelMap'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.GetPixelMap'");
...
static int gl_get_pointer(lua_State *L)
{
   ...
   /* test argument type */
   if(!( lua_isstring(L, 1) && lua_isnumber(L, 2) ))
      ShowError("incorrect argument to function 'gl.GetPointer'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.GetPointer'");
...
{
   int index;
   GLubyte *mask = NEW_ARRAY(GLubyte, 1024);
...
static int gl_get_string(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.GetString'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.GetString'");
...
static int gl_get_tex_env(lua_State *L)
{
   ...
   /* test arguments type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.GetTexEnv'");
   ...
   /* test argument */
   if(e1 == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.GetTexEnv'");
...
static int gl_get_tex_gen(lua_State *L)
{
   ...
   /* test arguments type */
   if( !(lua_isstring(L, 1) && lua_isstring(L, 2)) )
      ShowError("incorrect argument to function 'gl.GetTexGen'");
   ...
   /* test argument */
   if(e1 == ENUM_ERROR || e2 == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.GetTexGen'");
...
static int gl_get_tex_image(lua_State *L)
{
   ...
   if( !(lua_isstring(L, 1) && lua_isnumber(L, 2) && lua_isstring(L, 3)) )
      ShowError("incorrect argument to function 'gl.GetTexImage'");
   ...
   pixels = NEW_ARRAY(GLfloat, n * width * height);
...
static int gl_get_tex_level_parameter(lua_State *L)
{
   ...
   /* test arguments type */
   if( !(lua_isstring(L, 1) && lua_isnumber(L, 2) && lua_isstring(L, 3)) )
      ShowError("incorrect argument to function 'gl.GetTexLevelParameter'");
...
static int gl_get_tex_parameter(lua_State *L)
{
   ...
   /* test arguments type */
   if(! (lua_isstring(L, 1) && lua_isstring(L, 2) ))
      ShowError("incorrect argument to function 'gl.GetTexParameter'");
...
static int gl_hint(lua_State *L)
{
   ...
   /* test arguments type */
   if( !(lua_isstring(L, 1) && lua_isstring(L, 2)) )
      ShowError("incorrect argument to function 'gl.Hint'");
   ...
   /* test argument */
   if(e1 == ENUM_ERROR || e2 == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.Hint'");
...
static int gl_index(lua_State *L)
{
   ...
   if(lua_istable(L, 1))/* test argument type */
   {
      ...
      ShowError("incorrect argument to function 'gl.Index'");
...
static int gl_index_mask(lua_State *L)
{
   if(lua_type(L,1) == LUA_TSTRING)
      ...
      ShowError("incorrect argument to function 'gl.IndexMask'");
...
static int gl_index_pointer(lua_State *L)
{
   ...
   /* test arguments type */
   if(!lua_istable(L, 1))
      ShowError("incorrect argument to function 'gl.IndexPointer'");
...
static int gl_is_enabled(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.IsEnabled'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.IsEnabled'");
...
static int gl_is_list(lua_State *L)
{
   /* test argument type */
   if(!lua_isnumber(L, 1))
      ShowError("incorrect argument to function 'gl.IsList'");
...
static int gl_is_texture(lua_State *L)
{
   /* test argument type */
   if(!lua_isnumber(L, 1))
      ShowError("incorrect argument to function 'gl.IsTexture'");
...
static int gl_light(lua_State *L)
{
   ...
   /* test arguments type */
   if(!( lua_isstring(L, 1) && lua_isstring(L, 2) ))
      ShowError("incorrect argument to function 'gl.Light'");
   ...
   /* test argument */
   if(e1 == ENUM_ERROR || e2 == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.Light'");
...
static int gl_light_model(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.LightModel'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.LightModel'");
...
static int gl_line_stipple(lua_State *L)
{
   /* test arguments type */
   if(!lua_isnumber(L, 1))
      ShowError("incorrect argument to function 'gl.LineStipple'");
...
static int gl_line_width(lua_State *L)
{
   /* test argument type */
   if(!lua_isnumber(L, 1))
      ShowError("incorrect argument to function 'gl.LineWidth'");
...
static int gl_list_base(lua_State *L)
{
   /* test argument type */
   if(!lua_isnumber(L, 1))
      ShowError("incorrect argument to function 'gl.ListBase'");
...
static int gl_load_matrix(lua_State *L)
{
   ...
   if(!lua_istable(L, 1) || luaL_getn(L, 1) < 16)
      ShowError("incorrect argument to function 'gl.LoadMatrix'");
...
static int gl_load_name(lua_State *L)
{
   /* test argument type */
   if(!lua_isnumber(L, 1))
      ShowError("incorrect argument to function 'gl.LoadName'");
...
static int gl_logic_op(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.LogicOp'");
   ...
   if(opcode == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.LogicOp'");
...
static int gl_map(lua_State *L)
{
   ...
   /* test argument */
   if(!( lua_isstring(L, 1) && lua_isnumber(L, 2) && lua_isnumber(L, 3) ))
      ShowError("incorrect argument to function 'gl.Map'");
   ...
   if(target == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.Map'");
...
static int gl_map_grid(lua_State *L)
{
   ...
   if(!( lua_isnumber(L, 1) && lua_isnumber(L, 2) && lua_isnumber(L, 3) ))
      ShowError("incorrect argument to function 'gl.MapGrid'");
...
static int gl_material(lua_State *L)
{
   ...
   /* test arguments type */
   if( !(lua_isstring(L, 1) && lua_isstring(L, 2)) )
      ShowError("incorrect argument to function 'gl.Material'");
   ...
   /* test argument */
   if(e1 == ENUM_ERROR || e2 == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.Material'");
...
static int gl_matrix_mode(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.MatrixMode'");
   ...
   /* test argument */
   if(mode == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.MatrixMode'");
...
static int gl_mult_matrix(lua_State *L)
{
   ...
   /* test argument type and the number of arguments in the array, must be 16 values */
   if(!lua_istable(L, 1) || luaL_getn(L, 1) < 16)
      ShowError("incorrect argument to function 'gl.MultMatrix'");
...
static int gl_new_list(lua_State *L)
{
   ...
   /* test arguments type */
   if(!( lua_isnumber(L, 1) && lua_isstring(L, 2) ))
      ShowError("incorrect argument to function 'gl.NewList'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.NewList'");
...
static int gl_normal(lua_State *L)
{
   ...
   if(lua_istable(L, 1))
   {
      ...
      if(num_args < 3)
         ShowError("incorrect argument to function 'gl.Normal'");
...
static int gl_normal_pointer(lua_State *L)
{
   ...
   /* test arguments type */
   if(!lua_istable(L, 1))
      ShowError("incorrect argument to function 'gl.NormalPointer'");
   /* get argument */
   if(get_array2d_pointer(L, 1, &array, &size) == -1)
      size = get_arrayd_pointer(L, 1, &array) / 3;
...
static int gl_ortho(lua_State *L)
{
   ...
   if(!( lua_isnumber(L, 1) && lua_isnumber(L, 2) && lua_isnumber(L, 3) &&
         lua_isnumber(L, 4) && lua_isnumber(L, 5) && lua_isnumber(L, 6)))
      ShowError("incorrect string argument to function 'gl.Ortho'");
...
static int gl_pass_through(lua_State *L)
{
   /* test argument type */
   if(!lua_isnumber(L, 1))
      ShowError("incorrect string argument to function 'gl.PassThrough'");
...
static int gl_pixel_map(lua_State *L)
{
   ...
   /* test arguments */
   if(!( lua_isstring(L, 1) && lua_istable(L, 2) ))
      ShowError("incorrect argument to function 'gl.PixelMap'");
   ...
   /* test argument */
   if(map == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.PixelMap'");
...
static int gl_pixel_store(lua_State *L)
{
   ...
   /* test argument */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.PixelStore'");

   e = get_gl_enum(L, 1);

   /* test arguments */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.PixelStore'");
...
static int gl_pixel_transfer(lua_State *L)
{
   ...
   /* test argument */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.PixelTransfer'");

   e = get_gl_enum(L, 1);

   /* test arguments */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.PixelTransfer'");
...
static int gl_pixel_zoom(lua_State *L)
{
   /* test arguments type */
   if(!( lua_isnumber(L, 1) && lua_isnumber(L, 2) ))
      ShowError("incorrect string argument to function 'gl.PixelZoom'");
...
static int gl_point_size(lua_State *L)
{
   /* test arguments type */
   if(!lua_isnumber(L, 1))
      ShowError("incorrect string argument to function 'gl.PointSize'");
...
static int gl_polygon_mode(lua_State *L)
{
   ...
   /* test arguments type */
   if( !(lua_isstring(L, 1) && lua_isstring(L, 2)) )
      ShowError("incorrect argument to function 'gl.PolygonMode'");
   ...
   /* test argument */
   if(e1 == ENUM_ERROR || e2 == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.PolygonMode'");
...
static int gl_polygon_offset(lua_State *L)
{
   /* test arguments type */
   if(!( lua_isnumber(L, 1) && lua_isnumber(L, 2) ))
      ShowError("incorrect string argument to function 'gl.PolygonOffset'");
...
static int gl_polygon_stipple(lua_State *L)
{
   ...
   /* test arguments type */
   if(!lua_istable(L, 1))
      ShowError("incorrect argument to function 'gl.PolygonStipple'");
...
static int gl_prioritize_textures(lua_State *L)
{
   ...
   if(!( lua_istable(L, 1) && lua_istable(L, 2) ))
      ShowError("incorrect argument to function 'gl.PrioritizeTextures'");
...
static int gl_push_attrib(lua_State *L)
{
   ...
   /* test arguments type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.PushAttrib'");

   e = get_gl_enum(L, 1);

   /* test arguments */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.PushAttrib'");
...
static int gl_push_client_attrib(lua_State *L)
{
   ...
   /* test arguments type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.PushClientAttrib'");

   e = get_gl_enum(L, 1);

   /* test arguments */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.PushClientAttrib'");
...
static int gl_push_name(lua_State *L)
{
   /* test arguments type */
   if(!lua_isnumber(L, 1))
      ShowError("incorrect argument to function 'gl.PushName'");
...
static int gl_raster_pos(lua_State *L)
{
   ...
   {
      if(!lua_isnumber(L, index + 1))
         ShowError("incorrect argument to function 'gl.RasterPos'");
   }
...
static int gl_read_buffer(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.ReadBuffer'");
   ...
   /* test argument */
   if(mode == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.ReadBuffer'");
...
static int gl_read_pixels(lua_State *L)
{
   ...
   if(!(lua_isnumber(L, 1) && lua_isnumber(L, 2) &&
      ...
      ShowError("incorrect argument to function 'gl.ReadPixels'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.ReadPixels'");
...
static int gl_rect(lua_State *L)
{
   ...
   /* test argument type */
      ...
      ShowError("incorrect argument to function 'gl.Rect'");
...
static int gl_render_mode(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.RenderMode'");
   ...
   /* test argument */
   if(mode == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.RenderMode'");
...
static int gl_rotate(lua_State *L)
{
   ...
   if(!( lua_isnumber(L, 1) && lua_isnumber(L, 2) &&
         lua_isnumber(L, 3) && lua_isnumber(L, 4) ))
      ShowError("incorrect argument to function 'gl.Rotate'");
...
static int gl_scale(lua_State *L)
{
   /* test argument type */
   if(!( lua_isnumber(L, 1) && lua_isnumber(L, 2) && lua_isnumber(L, 3) ))
      ShowError("incorrect argument to function 'gl.Scale'");
...
static int gl_scissor(lua_State *L)
{
   /* test argument type */
   if(!( lua_isnumber(L, 1) && lua_isnumber(L, 2) && lua_isnumber(L, 3) && lua_isnumber(L, 4) ))
      ShowError("incorrect argument to function 'gl.Scissor'");
...
static int gl_select_buffer(lua_State *L)
{
   ...
   /* test arguments type */
   if(!lua_isnumber(L, 1))
      ShowError("incorrect argument to function 'gl.SelectBuffer'");

   size = (int)lua_tonumber(L, 1);

   buffer = NEW_ARRAY(GLuint, size);
...
static int gl_shade_model(lua_State *L)
{
   ...
   /* test argument type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.ShadeModel'");
   ...
   /* test argument */
   if(mode == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.ShadeModel'");
...
static int gl_stencil_func(lua_State *L)
{
   ...
   /* test arguments type */
   if(!( lua_isstring(L, 1) && lua_isnumber(L, 2) ))
      ShowError("incorrect argument to function 'gl.StencilFunc'");
   ...
   /* test argument */
   if(func == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.StencilFunc'");
...
static int gl_stencil_mask(lua_State *L)
{
   if(lua_type(L,1) == LUA_TSTRING)
      ...
      ShowError("incorrect argument to function 'gl.StencilMask'");
...
static int gl_stencil_op(lua_State *L)
{
   ...
   if( !(lua_isstring(L, 1) && lua_isstring(L, 2) && lua_isstring(L, 3) ))
      ShowError("incorrect argument to function 'gl.StencilOp'");
   ...
   if(e1 == ENUM_ERROR || e2 == ENUM_ERROR || e3 == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.StencilOp'");
...
static int gl_tex_coord(lua_State *L)
{
   ...
   if(num_args == 0)
      ShowError("incorrect argument to function 'gl.TexCoord'");
...
static int gl_tex_coord_pointer(lua_State *L)
{
   ...
   /* test arguments type */
   if(!lua_istable(L, 1))
      ShowError("incorrect argument to function 'gl.TexCoordPointer'");
...
int static gl_tex_env(lua_State *L)
{
   ...
   /* test arguments type */
   if(!lua_isstring(L, 1))
      ShowError("incorrect argument to function 'gl.TexEnv'");
   ...
   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.TexEnv'");
...
int static gl_tex_gen(lua_State *L)
{
   ...
   /* test arguments type */
   if(!( lua_isstring(L, 1) && lua_isstring(L, 2) ))
      ShowError("incorrect argument to function 'gl.TexGen'");
   ...
   /* test argument */
   if(e1 == ENUM_ERROR || e2 == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.TexGen'");
...
static int gl_tex_image(lua_State *L)
{
   ...
   /* test arguments type */
   if(lua_isnumber(L, 1) && lua_isnumber(L, 2) &&
      lua_isstring(L, 3) && lua_istable(L, 5) &&
      lua_isstring(L, 4)
      )
   {
      e = get_gl_enum(L, 3);
   ...
   {
      ShowError("incorrect argument to function 'gl.TexImage', target, num_color_channels, 'RGB|RGBA|RG|RED','FLOAT|UNSIGNED_BYTE|INT_UNSIGNED_INT|SHORT|UNSIGNED_SHORT',table with rows of pixels");
   }

   /* test argument */
   if(e == ENUM_ERROR)
      ShowError("incorrect pixel format enum string argument to function 'gl.TexImage' argument 3");
   if(pixelType == ENUM_ERROR || (pixelType != GL_FLOAT && 
      pixelType != GL_UNSIGNED_BYTE && pixelType != GL_INT && 
      pixelType != GL_UNSIGNED_INT))
      ShowError("incorrect data format enum string argument to function 'gl.TexImage' argument 4 can only be 'FLOAT|UNSIGNED_BYTE|INT|UNSIGNED_INT|INT_UNSIGNED_INT|SHORT|UNSIGNED_SHORT' for now");

   if(pixelType == GL_UNSIGNED_BYTE) 
   {
     GLubyte *pixels;
     if((height = get_array2ubyte(L, index, &pixels, &width)) != -1)
     {
     ...
     {
        width = get_arrayubyte(L, index, &pixels);
   ...
   {
     GLfloat *pixels;
     if((height = get_array2f(L, index, &pixels, &width)) != -1)
     {
        glTexImage2D(GL_TEXTURE_2D, (GLint)lua_tonumber(L, 1),
	           iformat, width/iformat, height, 0, e, pixelType, pixels);
     }
     else
     {
        width = get_arrayf(L, index, &pixels);
        glTexImage1D(GL_TEXTURE_1D, (GLint)lua_tonumber(L, 1),
	           iformat, width/iformat, 0, e, pixelType, pixels);
     }
     DELETE_ARRAY(pixels);
   }
   ...
   {
     GLint *pixels;
     if((height = get_array2i(L, index, &pixels, &width)) != -1)
     {
        glTexImage2D(GL_TEXTURE_2D, (GLint)lua_tonumber(L, 1),
	           iformat, width/iformat, height, 0, e, pixelType, pixels);
     }
     ...
     {
        width = get_arrayi(L, index, &pixels);
        glTexImage1D(GL_TEXTURE_1D, (GLint)lua_tonumber(L, 1),
	           iformat, width/iformat, 0, e, pixelType, pixels);
     }
     DELETE_ARRAY(pixels);
   ...
   {
     GLuint *pixels;
     if((height = get_array2ui(L, index, &pixels, &width)) != -1)
     {
        glTexImage2D(GL_TEXTURE_2D, (GLint)lua_tonumber(L, 1),
	           iformat, width/iformat, height, 0, e, pixelType, pixels);
     }
     ...
     {
        width = get_arrayui(L, index, &pixels);
        glTexImage1D(GL_TEXTURE_1D, (GLint)lua_tonumber(L, 1),
	           iformat, width/iformat, 0, e, pixelType, pixels);
     }
     DELETE_ARRAY(pixels);
   }
   else if(pixelType == GL_SHORT)
   {
     GLshort *pixels;
     if((height = get_array2short(L, index, &pixels, &width)) != -1)
     {
        glTexImage2D(GL_TEXTURE_2D, (GLint)lua_tonumber(L, 1),
	           iformat, width/iformat, height, 0, e, pixelType, pixels);
     }
     ...
     {
        width = get_arrayshort(L, index, &pixels);
        glTexImage1D(GL_TEXTURE_1D, (GLint)lua_tonumber(L, 1),
	           iformat, width/iformat, 0, e, pixelType, pixels);
     }
     DELETE_ARRAY(pixels);
   ...
   {
     GLushort *pixels;
     if((height = get_array2ushort(L, index, &pixels, &width)) != -1)
     {
        glTexImage2D(GL_TEXTURE_2D, (GLint)lua_tonumber(L, 1),
	           iformat, width/iformat, height, 0, e, pixelType, pixels);
     }
     ...
     {
        width = get_arrayushort(L, index, &pixels);
        glTexImage1D(GL_TEXTURE_1D, (GLint)lua_tonumber(L, 1),
	           iformat, width/iformat, 0, e, pixelType, pixels);
     }
     DELETE_ARRAY(pixels);
...
static int gl_tex_sub_image(lua_State *L)
{
   ...
   if(!( lua_isnumber(L, 1) && lua_isstring(L, 2) &&
      ...
      ShowError("incorrect argument to function 'gl.TexSubImage'");
   ...
   if(format == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.TexSubImage'");
...
static int gl_tex_parameter(lua_State *L)
{
   ...
   /* test arguments type */
   if(! (lua_isstring(L, 1) && lua_isstring(L, 2) ))
      ShowError("incorrect argument to function 'gl.TexParameter'");
   ...
   /* test argument */
   if(e1 == ENUM_ERROR || e2 == ENUM_ERROR)
      ShowError("incorrect string argument to function 'gl.TexParameter'");
...
static int gl_translate(lua_State *L)
{
   /* test arguments type */
   if(!( lua_isnumber(L, 1) && lua_isnumber(L, 2) && lua_isnumber(L, 3) ))
      ShowError("incorrect argument to function 'gl.Translate'");
...
static int gl_vertex(lua_State *L)
{
   ...
   /* if have there's no arguments show an error message */
   if(num_args == 0)
      ShowError("incorrect argument to function 'gl.Vertex'");
...
static int gl_vertex_pointer(lua_State *L)
{
   ...
   /* test arguments type */
   if(!lua_istable(L, 1))
      ShowError("incorrect argument to function 'gl.VertexPointer'");
...
static int gl_viewport(lua_State *L)
{
   ...
   if(!( lua_isnumber(L, 1) && lua_isnumber(L, 2) &&
         lua_isnumber(L, 3) && lua_isnumber(L, 4) ))
      ShowError("incorrect argument to function 'gl.Viewport'");
...
LUAGL_API int luaopen_libLuaGL (lua_State *L) {
